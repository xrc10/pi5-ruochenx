...
/* First created by JCasGen Fri Oct 02 00:04:14 EDT 2015 */
package type;
 ...
 * Updated by JCasGen Fri Oct 02 00:04:14 EDT 2015
...
public class Evaluation extends ComponentAnnotation {
  ...
  */  
  ...
  /** getter for questions - gets The questions whose performance is evaluated.
   * @generated
  ...
  /** setter for questions - sets The questions whose performance is evaluated. 
   * @generated
  ...
  /** indexed getter for questions - gets an indexed value - The questions whose performance is evaluated.
   * @generated
   * @param i index in the array to get
   * @return value of the element at index i 
   */
  public TOP getQuestions(int i) {
    if (Evaluation_Type.featOkTst && ((Evaluation_Type)jcasType).casFeat_questions == null)
      jcasType.jcas.throwFeatMissing("questions", "type.Evaluation");
    jcasType.jcas.checkArrayBounds(jcasType.ll_cas.ll_getRefValue(addr, ((Evaluation_Type)jcasType).casFeatCode_questions), i);
    return (TOP)(jcasType.ll_cas.ll_getFSForRef(jcasType.ll_cas.ll_getRefArrayValue(jcasType.ll_cas.ll_getRefValue(addr, ((Evaluation_Type)jcasType).casFeatCode_questions), i)));}

  /** indexed setter for questions - sets an indexed value - The questions whose performance is evaluated.
   * @generated
   * @param i index in the array to set
   * @param v value to set into the array 
   */
  public void setQuestions(int i, TOP v) { 
    if (Evaluation_Type.featOkTst && ((Evaluation_Type)jcasType).casFeat_questions == null)
      jcasType.jcas.throwFeatMissing("questions", "type.Evaluation");
    jcasType.jcas.checkArrayBounds(jcasType.ll_cas.ll_getRefValue(addr, ((Evaluation_Type)jcasType).casFeatCode_questions), i);
